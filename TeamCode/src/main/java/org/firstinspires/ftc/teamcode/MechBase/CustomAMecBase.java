 ...
 */
public abstract class CustomAMecBase extends LinearOpMode {


	public DcMotor     FL;     // The front left motor
	public DcMotor     FR;     // The front right motor
	public DcMotor     RR;     // The right rear motor
	public DcMotor     LR;     // The left rear motor
	 ...
	 * runOpMode() is called
	 */
	public void preStartInitialization() {


		// Initialize the hardware variables from the hardware map
		FL = hardwareMap.dcMotor.get("LeftFrontMotor");
		LR = hardwareMap.dcMotor.get("LeftBackMotor");
		FR = hardwareMap.dcMotor.get("RightFrontMotor");
		RR = hardwareMap.dcMotor.get("RightBackMotor");
	 ...
	 */
	public void setPower(final double powerRF, final double powerRR,final double powerLF,final double powerLR) {
		FL.setPower(powerLF);
		LR.setPower(powerLR);
		FR.setPower(powerRF);
		RR.setPower(powerRR);
	 ...
	 */
	public void setDrive(double forward, double sideways, double rotation) {
		double scale = 1.0;
	...
	public void setStrafe(double forward, double sideways, double rotation) {
		double scale = 1.0;
		double max = Math.abs(forward) + Math.abs(sideways) + Math.abs(rotation);
		if (max > 1.0) {
			scale = 1.0 / max;
	 ...
	 */
	final public void move(double inches, double degrees) {
	 ...
	 */
	final public void move(double inches, double degrees, double maxPower) {
		FL.setDirection(DcMotorSimple.Direction.REVERSE);
		LR.setDirection(DcMotorSimple.Direction.REVERSE);
		FR.setDirection(DcMotorSimple.Direction.FORWARD);
		RR.setDirection(DcMotorSimple.Direction.FORWARD);
	...
	final public void strafe(double inches, double degrees, double maxPower) {
		FL.setDirection(DcMotorSimple.Direction.FORWARD);
		LR.setDirection(DcMotorSimple.Direction.REVERSE);
		FR.setDirection(DcMotorSimple.Direction.FORWARD);
		RR.setDirection(DcMotorSimple.Direction.REVERSE);
		strafe(inches, degrees, maxPower, mtrAccelMin, mtrAccelTics, mtrDecelMin, mtrDecelTics);
	}
